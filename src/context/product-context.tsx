...
const mockProducts: Product[] = [
  ...
  { id: "3", name: "Retro Round", brandId: 'prada', price: 1200, category: "Sunglasses", gender: 'Femme', image: "https://placehold.co/600x400.png", colors: ["Bronze", "Matte Black"], tags: ["Vintage"], rating: 4.6, reviews: 95, description: "Channel a vintage vibe with these perfectly round sunglasses, inspired by the icons of the past." },
  ...
  { id: "5", name: "Cat-Eye Chic", brandId: 'tom-ford', price: 1650, category: "Sunglasses", gender: 'Femme', image: "https://placehold.co/600x400.png", colors: ["Rose Gold", "Black"], tags: ["Glamorous"], rating: 4.7, reviews: 150, description: "Make a statement with these glamorous cat-eye sunglasses, designed to turn heads.", ribbon: 'New Arrival' },
  { id: "6", name: "Scholarly Specs", brandId: 'ray-ban', price: 950, category: "Eyeglasses", gender: 'Homme', image: "https://placehold.co/600x400.png", colors: ["Silver", "Gunmetal"], tags: ["Smart", "Sophisticated"], rating: 4.4, reviews: 88, description: "Smart and sophisticated, these rectangular frames are perfect for the office or the library." },
  { id: "7", name: "Sporty Wraparounds", brandId: 'oakley', price: 1900, category: "Sunglasses", gender: 'Homme', image: "https://placehold.co/600x400.png", colors: ["Red", "Blue"], tags: ["Performance", "Secure Fit"], rating: 4.8, reviews: 210, description: "Engineered for performance, these wraparound sunglasses provide maximum coverage and a secure fit." },
  ...
  { id: "9", name: "Daily Comfort", brandId: 'acuvue', price: 300, category: "Contact Lens", gender: 'Unisex', image: "https://placehold.co/600x400.png", colors: ["Clear"], tags: ["Daily", "Disposable"], rating: 4.9, reviews: 500, description: "Experience all-day comfort with these daily disposable contact lenses.", ribbon: "Most Popular" },
